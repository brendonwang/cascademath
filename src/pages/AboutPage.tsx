        ...
        >
          <div className="grid max-w-[40rem] gap-[1.1rem]">
            ...
            <p className={sectionCopyClass}>
              We’re a student-run nonprofit in Seattle. We make math events where people can think
              hard, try new ideas, and enjoy the day together.
            </p>
          </div>
        ...
        <div className="grid grid-cols-[1.6rem_minmax(0,1fr)] items-start gap-4 border-y border-border py-5">
          ...
          <div>
            ...
            <p className="mt-2 max-w-[58rem] text-[1.02rem] leading-[1.62] text-muted-foreground">
              Give students room to explore challenging math with other people.
            </p>
          </div>
        </div>
      </PageSection>
          ...
          {teamSlots.map((slot, index) => (
            ...
            >
              <header className="flex items-baseline gap-3">
                <span className="font-mono text-[0.72rem] font-[650] tabular-nums text-primary" aria-hidden="true">
