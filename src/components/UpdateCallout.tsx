...
export function UpdateCallout({
  ...
  description = "Be the first to know when new events are announced.",
  id = "mailing-list",
}: {
  title?: string;
  description?: string;
  ...
  return (
    ...
    >
      ...
      <div className="relative grid gap-[0.4rem]">
        <h2
          id={headingId}
          className="text-[clamp(1.3rem,2vw,1.65rem)] font-[650]"
        >
          {title}
        </h2>
